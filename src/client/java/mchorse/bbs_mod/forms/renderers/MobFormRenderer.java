...
public class MobFormRenderer extends FormRenderer<MobForm> implements ITickable
{
    ...
    public List<String> getBones()
    {
        ...
        if (this.entity != null)
        {
            VanillaRendererBones.Discovery discovery = VanillaRendererBones.discover(
                MinecraftClient.getInstance().getEntityRenderDispatcher().getRenderer(this.entity)
            );

            return discovery.getBoneHierarchy().getBoneIds();
        }
    ...
    private Pose mergeOverlays()
    {
        ...
        for (mchorse.bbs_mod.settings.values.core.ValuePose additional : this.form.additionalOverlays)
        {
